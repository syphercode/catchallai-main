...
import { Separator as SeparatorRaw } from '@/components/ui/separator';
import { Sheet, SheetContent } from '@/components/ui/sheet';
import { Skeleton } from '@/components/ui/skeleton';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/components/ui/tooltip';

// `separator.jsx` doesn't yet expose proper TS prop types. Re-cast Separator
// against its underlying Radix primitive shape so consumers (and this file)
// get real prop autocomplete and prop-type checking. Once CS-2368 migrates
// `separator.jsx` to `.tsx`, this assertion shim can be removed and the
// import inlined again. (The matching shims for sheet and tooltip were
// removed in CS-2366 once those files migrated.)
const Separator = SeparatorRaw as ForwardRefExoticComponent<
  ComponentPropsWithoutRef<typeof SeparatorPrimitive.Root> &
    RefAttributes<ElementRef<typeof SeparatorPrimitive.Root>>
>;
...
const SidebarInset = forwardRef<HTMLElement, ComponentProps<'main'>>(
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
