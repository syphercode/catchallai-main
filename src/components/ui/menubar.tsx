...
// shadcn/ui Menubar primitive wrappers around Radix's
// `@radix-ui/react-menubar`. Exposes the full composable surface
...
// `MenubarSubTrigger`, `MenubarSubContent`, `MenubarGroup`, `MenubarPortal`)
// pre-styled with project Tailwind tokens. Exists so feature code can compose
// desktop-style menubar UIs without re-deriving Radix wiring or chrome.
