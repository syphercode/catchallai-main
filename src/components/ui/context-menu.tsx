// shadcn/ui ContextMenu primitive wrappers around Radix's
// `@radix-ui/react-context-menu`. Exposes the full composable surface
...
// `ContextMenuSubTrigger`, `ContextMenuRadioGroup`) pre-styled with project
// Tailwind tokens. Exists so feature code can compose right-click context menus
// without re-deriving Radix wiring or chrome.
